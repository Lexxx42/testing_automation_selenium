...
# В списках может быть разрешено выбирать как только один,
# так и несколько вариантов, в зависимости от типа списка.
...
# Для того чтобы найти элемент с текстом "Python",
