# Ну что, теперь у нас есть все необходимые знания для того,
...
# Наверное, теперь мы бы хотели, чтобы каждый раз,
# во время вызова a_stand_alone_function,
# вместо неё вызывалась a_stand_alone_function_decorated.

# Нет ничего проще, просто перезапишем a_stand_alone_function функцией,
