...
# — часто используемые в формах элементы.
# Основная разница между ними состоит в том,
...
# Оба этих элемента создаются при помощи тега input
# со значением атрибута type равным checkbox или radio соответственно.
# В html-коде страницы вы увидите:

# <input type="checkbox">
# <input type="radio">

# Если checkbox или radiobutton выбран,
# то у элемента появится новый атрибут checked без значения.
# Часто атрибут checked уже установлен для одного из элементов по умолчанию.

# <input type="checkbox" checked>
# <input type="radio" checked>

# Radiobuttons объединяются в группу,
# где все элементы имеют одинаковые значения атрибута name,
# но разные значения атрибута value:

# <input type="radio" name="language" value="python" checked>
# <input type="radio" name="language" value="selenium">

# Checkboxes могут иметь как одинаковые,
# так и разные значения атрибута name.
...
# Чтобы снять/поставить галочку в элементе типа checkbox или
...
# который отображается рядом с флажком.
