...
# Мы видим, что в данном примере браузер открылся один раз
# и тесты последовательно выполнились в этом браузере.
# Здесь мы проделали это в качестве примера,
# но мы крайне рекомендуем всё же запускать отдельный экземпляр браузера для каждого теста,
# чтобы повысить стабильность тестов.
# Фикстуры, которые занимают много времени для запуска и ресурсов
# (обычно это работа с базами данных),
