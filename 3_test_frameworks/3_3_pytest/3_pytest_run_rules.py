...
# Когда мы выполняем команду pytest,
...
# * как аргумент можно передать файл,
# путь к директории или любую комбинацию директорий и файлов, например:
...
# * во всех директориях PyTest ищет файлы,
# которые удовлетворяют правилу  test_*.py или *_test.py
