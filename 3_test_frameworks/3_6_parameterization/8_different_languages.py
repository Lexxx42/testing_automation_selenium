...
# Цель: научиться запускать автотесты для разных локалей,
# т.е. для разных языков интерфейсов.
...
# Давайте сделаем так, чтобы сервер сам решал, какой язык интерфейса нужно отобразить,
# основываясь на данных браузера.
...
# В конструктор webdriver.Chrome или webdriver.Firefox
# вы можете добавлять разные аргументы,
...
# Предполагаем, что эти возможности вам понадобятся позже
