...
# Предположим, у нас есть smoke-тесты,
# которые нужно запускать только для определенной операционной системы,
# например, для Windows 10.

# Зарегистрируем метку win10 в файле pytest.ini,
