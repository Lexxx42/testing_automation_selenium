...
# Обратите внимание!
# При создании объекта мы обязательно передаем ему тот же самый
# объект драйвера для работы с браузером,
# а в качестве url передаем текущий адрес.

# Теперь в тесте нам не нужно думать про инициализацию страницы: она уже создана.
# Сохранив возвращаемое значение в переменную,
...
# Сейчас оставьте второй вариант с явной инициализацией страниц в теле теста,
# чтобы избежать лишних сложностей с циклическими зависимостями.
